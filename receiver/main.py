...
from handlers import start_handler, end_handler, upload_files_handler, select_filters_handler, send_google_url_handler, select_month_handler, table_handler, bot_menu_handler, \
    add_filter_handler, config_download_handler
...
def init_handlers():
    ...
    dp.register_message_handler(config_download_handler, state=BotState.config_file, content_types=types.ContentType.DOCUMENT)
